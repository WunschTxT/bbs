# Generated by Django 2.0.7 on 2020-03-02 09:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('article', models.ForeignKey(on_delete=None, to='app01.Article')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ForeignKey(on_delete=None, to='app01.Tag'),
        ),
        migrations.AddField(
            model_name='article',
            name='blog',
        ...
        migrations.AddField(
            model_name='article',
            name='classify',
            field=models.ForeignKey(on_delete=None, to='app01.Classify'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
